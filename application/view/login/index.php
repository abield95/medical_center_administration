<header>
    <link rel="stylesheet" type="text/css" href="<?php echo Config::get('URL') ?>css/login.css">
</header>

<section class="login_cont_section">
    <div class="content">
        <div class="container_login">
            ...
            <div class="login-page-box">
                <div class="table-wrapper">
                    ...
                    <div class="login-box">
                        <h2>Login here</h2>
                        <form id="loginForm" action="<?php echo Config::get('URL'); ?>login/login" method="post">
